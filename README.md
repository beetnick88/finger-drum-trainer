...
- 設定タブから曲を選択可能
- 「怪獣の花唄」と「ライラック」の原曲MIDI伴奏 + ドラム練習ノーツを収録
...
- 怪獣の花唄 Easy / Full Drum
- ライラック Easy / Full Drum

ライラックは、提供された `Mrs. GREEN APPLE - ライラック (Lilac).mid` からドラムチャンネルを練習ノーツ、それ以外のチャンネルを伴奏用シンセとして分離しています。原曲音源は同梱せず、YouTube公式MVを構成確認の参考にしています。
